...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<UpgradingStationRecipe>> UPGRADING_STATION_SERIALIZER =
            SERIALIZERS.register("upgrading",
                    () -> UpgradingStationRecipe.Serializer.INSTANCE);
