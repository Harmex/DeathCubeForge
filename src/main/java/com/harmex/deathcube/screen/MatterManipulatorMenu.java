...
public class MatterManipulatorMenu extends AbstractContainerMenu {
    ...
    public MatterManipulatorMenu(int pContainerId, Inventory inventory, FriendlyByteBuf extraData) {
        this(pContainerId, inventory, inventory.player.level.getBlockEntity(extraData.readBlockPos()));
    }

    public MatterManipulatorMenu(int pContainerId, Inventory inventory, BlockEntity blockEntity) {
