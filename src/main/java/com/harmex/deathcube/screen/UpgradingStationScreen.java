...
public class UpgradingStationScreen extends AbstractContainerScreen<UpgradingStationMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(DeathCube.MODID, "textures/gui/upgrading_station_gui.png");

    public UpgradingStationScreen(UpgradingStationMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
