...
/**
 * Deferred Register for DeathCube's Block Entities.
 */
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<UpgradingStationBlockEntity>> UPGRADING_STATION_BLOCK_ENTITY =
            BLOCK_ENTITIES.register("upgrading_station",
                    () -> BlockEntityType.Builder.of(UpgradingStationBlockEntity::new,
                            ModBlocks.UPGRADING_STATION.get()).build(null));
